...
$activityname = $startDate = $endDate = $purposeofactivity  = $organizedby = $F_NAME = $currentTimestamp = "";
            ...
            <div class="col-md-8">
			  ...
			  <div class="box-header with-border">
                ...
                <div class="icon">
					...
					<br>	
					<b><a href="menu.php?menu=7 " style="font-size:15px;">Extra-Curricular Activity</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="2_dashboard_hod_excurricular.php" style="font-size:15px;">&nbsp;View/Edit Activity</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="#" style="font-size:15px;">&nbsp;Edit Extra-Curricular Activity</a></b>					
				</div>
				</div><!-- /.box-header -->
                <!-- form start -->
...
?>				
			   ...
			   <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-12">
                         <a href="2_dashboard_excurricular.php" type="button" class="btn btn-warning btn-lg">Cancel</a>
