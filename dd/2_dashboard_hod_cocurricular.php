    ...
    <table  class="table table-stripped table-bordered " id = 'example1'>
        ...
        if(mysqli_num_rows($result)>0  ){
            ...
            while($row =mysqli_fetch_assoc($result)){
                ...
                echo "<td>
                    <form action = '3_edit_hod_cocurricular.php' method = 'POST'>
                        <input type = 'hidden' name = 'id' value = '".$row['co_curricular_ID']."'>
                        <button type = 'submit' class = 'btn btn-primary btn-sm'>
        ...
        ?>
			...
			<?php if ($_SESSION['rows'] > 0) {?>
	            ...
	            <a href="count_all_cocurricular.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon ">Count Co-Curricular Activities</span></a> 
	          <a href="export_to_excel_hod_cocurricular.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon ">Export to Excel</span></a>
