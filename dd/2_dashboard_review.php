...
<?php if(!isset($_GET['alert'])){ ?>
    ...
    <table  class="table table-stripped table-bordered " id = 'example1'>
		...
		<?php if ($_SESSION['rows'] > 0) {?>
	            ...
	            <div class="text-left"><a href="actcount_review.php"type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus">Add Technical Paper Reviewed</span></a>
	            <a href="count_your_review.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon ">Count Technical Papers Reviewed</span></a> 
	            <a href="export_to_excel_review_faculty.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon ">Export to Excel</span></a> 
<?php }else {?>
	            <div class="text-left"><a href="actcount_review.php"type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus">Add Technical Paper Reviewed</span></a>
<?php } ?>
