              ...
              <div class="box box-primary">
                <div class="box-header with-border">
				  <div class="icon">
					...
					<br>
					<b><a href="menu.php?menu=5 " style="font-size:15px;">Online/Offline Course Organised</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="actcount_course_organised.php" style="font-size:15px;">&nbsp;No. of Online/Offline Courses</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="#" style="font-size:15px;">&nbsp;Add Online/Offline Course</a></b>	
					</div>
                </div>
