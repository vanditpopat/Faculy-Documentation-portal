...
$query="SELECT * from any_other_activity where Fac_ID = $fid ";
	 ...
	 if(empty($_POST['enddate[]'])){
	  ...
	  //checking if there was an error or not
       ...
       if($result){
        ...
        $sql="INSERT INTO any_other_activity(Fac_ID,activity_name,Date_from,Date_to,purpose_of_activity,organized_by) VALUES ('$author','$activityname','$startDate','$endDate','$purposeofactivity','$organizedby')";
			...
			if($success == 1)	
			{
				...
				$result = mysqli_query($conn,$query);*/
				 if($_SESSION['username'] == ('hodextc@somaiya.edu') || $_SESSION['username'] == ('member@somaiya.edu') || $_SESSION['username'] == ('hodcomp@somaiya.edu') ){
 					header("location:2_dashboard_hod_anyother.php?alert=success");

				 }
				 else
  					header("location:2_dashboard_anyother.php?alert=success");
			 ...
			 <div class="box box-primary">
                <div class="box-header with-border">
				 <div class="icon">
					...
					<h3 class="box-title"><b>Any Other Activity Activities Form</b></h3>
					<br>
					<b><a href="menu.php?menu=8 " style="font-size:15px;">Any Other Activity Activities Menu</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="actcount_anyother.php" style="font-size:15px;">&nbsp;No. of Papers</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="#" style="font-size:15px;">&nbsp;Add Any Other Activity</a></b>	
				</div>
                </div><!-- /.box-header -->
                <!-- form start -->
			...
			<form role="form" method="POST" class="row" action ="" style= "margin:10px;" >
                   ...
                   <?php
                    ...
                    <div class="form-group col-md-12">
                         ...
                         <a href="2_dashboard_anyother.php" type="button" class="btn btn-warning pull-right btn-lg">Cancel</a>
                    </div>
                </form>
                </div>
              </div>
