	  ...
	  //checking if there was an error or not
       ...
       if($result){
        ...
        $sql="INSERT INTO attended(Fac_ID,Act_title,Act_type,Organized_by,Date_from,Date_to, Location,FDC_Y_N,Status_Of_Activity,Equivalent_Duration,Awards) VALUES ('$author','$Act_title','$Act_type','$organized_by','$startDate','$endDate','$location','$fdc','$status_activities','$no_of_hours','$awards')";
			...
			if($success == 1)	
			{
				$query = "SELECT * FROM attended where Fac_ID = $author and FDC_Y_N = 'yes' ;";
				$result = mysqli_query($conn,$query);
				 if(mysqli_num_rows($result)>0 )
				 {
		 ...
		 <div class="box box-primary">
                <div class="box-header with-border">
				 <div class="icon">
					...
					<br>
					<b><a href="menu.php?menu=3 " style="font-size:15px;">STTP/Workshop/FDP Attended/Organised Menu</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="actcount_attend.php" style="font-size:15px;">&nbsp;No. of Activities</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="#" style="font-size:15px;">&nbsp;Add Attended Activity</a></b>	
				</div>
                </div><!-- /.box-header -->
			...
			<form role="form" method="POST" class="row" action ="" style= "margin:10px;align:center" >
                     ...
                     <div class="form-group col-md-6">
                      ...
                      <div class="form-group col-md-6">
                         ...
                         <textarea required class="form-control input-lg" id="organized_by" name="organized_by[]" rows="3"></textarea>
                     </div>
                    ...
                    <div class="form-group col-md-6">
                     ...
                     <!-- New added elements -->
                        ...
                        <br><br>
                        <input   class="form-control input-lg" type="text" name="no_of_hours[]" id="no_of_hours" placeholder="Hours" value="1">
                        </div>

                        <div class="form-group col-md-6">
                        <label for="awards">Awards (If Any)</label>
                        <br>
                        <textarea class="form-control input-lg" name="awards[]" id="awards">No awards</textarea>
