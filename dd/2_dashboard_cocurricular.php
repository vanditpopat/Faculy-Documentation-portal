...
$fid = $_SESSION['Fac_ID'];
//query and result
$query = "SELECT * FROM co_curricular where Fac_ID ='".$_SESSION['Fac_ID']."' ;";
...
<div class="content-wrapper">
			...
			<?php } ?>
              <div class="box box-primary">
                <div class="box-header with-border">
					...
					<br>
					<b><a href="menu.php?menu=6 " style="font-size:15px;">Co-Curricular Activity</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="#" style="font-size:15px;">&nbsp;View/Edit Activity</a></b>	
					</div>

			   </div><!-- /.box-header -->
				<div style="text-align:right">
			<!--		<a href="menu.php?menu=6 "> <u>Back to Co-curricular Menu</u></a> -->
				</div>
                <div class="box-body">
				<div class="scroll">
    <table  class="table table-stripped table-bordered " id = 'example1'>
        ...
        <?php
		$p1=$_SESSION['Fac_ID'];
		$query = "SELECT * FROM co_curricular where Fac_ID ='$p1'";
        $result = mysqli_query($conn,$query);
		...
		<?php if ($_SESSION['rows'] > 0) {?>
	            ...
	            <div class="text-left"><a href="actcount_cocurricular.php"type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus">Add Activity</span></a>
	           <a href="count_your_cocurricular.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon ">Count Co-curricular Activity</span></a> 

	            <a href="export_to_excel_cocurricular.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon ">Export to Excel</span></a> 
	   <?php }else {?>
