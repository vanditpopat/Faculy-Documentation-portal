       ...
       if($result){
        ...
        $sql="INSERT INTO ex_curricular(Fac_ID,activity_name,Date_from,Date_to,purpose_of_activity,organized_by) VALUES ('$author',$activityname,$startDate,$endDate,$purposeofactivity,$organizedby)";
			...
			if($success == 1)	
			{
				 ...
				 if($_SESSION['username'] == ('hodextc@somaiya.edu') || $_SESSION['username'] == ('member@somaiya.edu') || $_SESSION['username'] == ('hodcomp@somaiya.edu') )
					 header("location:2_dashboard_hod_excurricular.php?alert=success");
				 else
				...
				<div class="form-group col-md-6">
                   ...
                   <?php
                    ...
                    <div class="form-group col-md-12">
                         ...
                         <a href="2_dashboard_hod_excurricular.php" type="button" class="btn btn-warning pull-right btn-lg">Cancel</a>
                    </div>
                </form>
                </div>
              </div>
