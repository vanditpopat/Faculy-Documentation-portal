...
<?php if(!isset($_GET['alert'])){ ?>
			...
			<?php } ?>
              <div class="box box-primary">
                <div class="box-header with-border">
					...
					<h2 class="box-title"><b>Paper Publication/Presentation Details</b></h2> <?php echo $_SESSION['Fac_ID'];?>
					<br>
	...
	<?php if ($_SESSION['rows'] > 0) {?>
	            ...
	            <a href="export_to_excel_publication_faculty.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon ">Export to Excel</span></a> 
	<?php }else {?>
		            <div class="text-left"><a href="actcount.php"type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus">Add Paper</span></a>
