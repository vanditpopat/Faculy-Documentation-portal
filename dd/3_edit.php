            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
				...
				<div class="icon">
					...
					<br>
					<b><a href="menu.php?menu=1 " style="font-size:15px;">Paper Publication</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="2_dashboard.php" style="font-size:15px;">&nbsp;View/Edit Activity</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="#" style="font-size:15px;">&nbsp;Edit Paper</a></b>	
				</div>
                </div><!-- /.box-header -->
...
?>						 					 
					    ...
					    <div class="form-group col-md-6">
                         ...
                         <textarea class="form-control input-lg" id="coauthors" name="coauthors" rows="2"><?php echo $coAuthors; ?></textarea>
                     </div>
					
					 <div class="form-group col-md-6">
                         <label for="volume">Volume/Issue/ISSN </label>
                         <textarea class="form-control input-lg" id="volume" name="volume" rows="2"><?php echo $volume; ?></textarea>
                     </div>
